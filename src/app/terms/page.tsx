...
const HorizontalRule = () => {
  return <hr className="border-primary my-10 -mx-2" />;
};
    ...
    <MainLayout>
      <div className="flex flex-col gap-20 md:mt-10">
        <div className="container mx-auto px-8  max-w-7xl text-[#787878] leading-relaxed">
          ...
          <div className="">
            Welcome to{" "}
            <span className="font-medium text-primary">leashpay.com</span>. By
            using <span className="font-medium text-primary">leashpay.com</span>{" "}
            YOU AGREE TO BE BOUND BY ITS CONDITIONS OF USE (explained below),
            Privacy Policy and all disclaimers and terms and conditions that
            appear elsewhere on
            <span className="font-medium text-primary">leashpay.com</span>. We
            reserve the right to make changes to{" "}
            <span className="font-medium text-primary">leashpay.com</span>
            and its (a) Conditions of Use, (b) Privacy Policy, (c) Refund Policy
            and (d) Chargeback Policy at any time (a, b, c and d are all
            available on{" "}
            <span className="font-medium text-primary">leashpay.com</span>).
            Each time you use{" "}
            <span className="font-medium text-primary">leashpay.com</span>, you
            should visit and review the then current Conditions of Use, Privacy,
            Refund and Chargeback Policies that apply to your transactions and
            use of{" "}
            <span className="font-medium text-primary">leashpay.com</span>. If
            you are dissatisfied with{" "}
            <span className="font-medium text-primary">leashpay.com</span>, its
            content or Conditions of Use, you agree that your sole and exclusive
            ...
            activities on{" "}
            <span className="font-medium text-primary">leashpay.com</span> is
            prohibited.
          </div>
          <HorizontalRule />
          <div className="flex flex-col gap-8">
            ...
            <div>
              By using <span className="highlightText">leashpay.com</span>, you
              expressly agree that use of
              <span className="highlightText">leashpay.com</span> is at your
              sole risk. <span className="highlightText">leashpay.com</span> is
              provided on an “as is” and “as available” basis. Neither{" "}
              <span className="highlightText">leashpay.com</span>, nor any of
              its associates, including but not limited to its directors,
              ...
              Associates be liable for any direct, indirect, incidental, special
              or consequential damages that result from your use of or inability
              to use <span className="highlightText">leashpay.com</span>,
              including but not limited to your reliance, on any information
              obtained from <span className="highlightText">leashpay.com</span>
              that results in mistakes, omissions, interruptions, deletion or
              corruption of files, viruses, delays in operation or transmission,
              or any failure of performance. The foregoing limitation shall
              apply in any action, whether in contract, tort or any other claim,
              even if an authorized representative of{" "}
              <span className="highlightText">leashpay.com</span> has been
              advised of or should have knowledge of the possibility of such
              damages. You hereby acknowledge that this paragraph shall apply to
          ...
          <div className="flex flex-col gap-8">
            ...
            <div>
              <span className="highlightText">leashpay.com</span> may charge a
              small convenience fee for certain services. Other services may be
              offered at face value with no additional charge from{" "}
              <span className="highlightText">leashpay.com</span>. Convenience
          ...
          <div className="flex flex-col gap-8">
            ...
            <div>
              After you initiate a payment or place an order using our shopping
              cart, we will validate the information you give us, by verifying
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-6">
              ...
              <h1 className="text-3xl text-primary">What is a Chargeback?</h1>
              <div>
                A chargeback is a reversal of a credit/debit card transaction by
                your bank. Chargebacks are usually performed when fraudulent
                purchases have been made on a person’s credit/debit card. You
                can initiate such a request if you find a charge on your account
                that you did not authorize, or a charge for an item that you did
                not receive. If you need to request a chargeback, please contact
                us first so we can help you resolve the issue. In most cases,
                our refund policy is the appropriate route to take instead of a
                chargeback request.
              </div>
            </div>
